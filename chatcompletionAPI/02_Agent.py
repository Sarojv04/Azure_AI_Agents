import os, time
from azure.ai.projects import AIProjectClient # This allows to connect to Azure AI Foundry using the Project Connection String, and once connected it gives access to all project resources like agents, threads , models, messages. 
from azure.identity import DefaultAzureCredential # To connect with my Azure account with my credentials 
...
with project_client:
    ...
    message = project_client.agents.create_message(thread_id=thread.id, role="user", content="Describe the world in 20 words or less")
    # [END create_message]
