...
model = os.getenv("MODEL_DEPLOYMENT_NAME_EX")
...
with project_client:
    ...
    message = project_client.agents.create_message(
        thread_id=thread.id,
        role="user",
            content="""I have provided a CSV file with product data. 
                        Please read it as a CSV file and create a column chart 
                        with products on the x-axis and their respective prices 
                        on the y-axis.""",
